...
/* --- Mission System Settings --- */
	...
	/* --- ALTIS MAP ONLY --- */
		...
		IMS_Overmind_SaticMission_Arr			= 0;																									
		/* 
			IMS_FortressSaticMission_Arr NOTE:
			This value has to be set to succsesfull complete the DMS Mission part without killing all NPCs. 	
			The value depents on the load order of static DMS missions. 
		...
		*/
		...
		IMS_Overmind_Timer						= 10;	//Time in seconds for the bomb timer. This is just a option for testing things and for reduce/delay the timer.
		
		/* --- Loot Crate Settings --- */
		IMS_Overmind_LootWeapons				= ["srifle_GM6_ghex_F","srifle_DMR_07_hex_F","srifle_LRR_tna_F","SMG_05_F","arifle_MX_SW_khk_F","LMG_03_F","arifle_ARX_ghex_F","arifle_MXC_khk_F"];	// Loot Weapons in the crate after Fortress Mission success.
		IMS_Overmind_LootAmmoAmount				= 3;	// Amount of magazines for every Weapon in IMS_FortressLootWeapons for the crate.
		IMS_Overmind_MedicalItems				= ["Exile_Item_InstaDoc","Exile_Item_Bandage"];	// Madical Items in the crate after Fortress Mission success.
		IMS_Overmind_GearItems					= [];	// Gear Items in the crate after Fortress Mission success.
		IMS_Overmind_PoptabsLoot				= 25000;	// Ammount of Poptabs in the crate on Fortress mission success set to 0 to disable this option.
	
		/* --- Vehicle Spawn Settings --- */
		IMS_Overmind_VehicleLoot				= true;	// Enable/disable vehicle loot spawn on Fortress mission success.
		IMS_Overmind_VehicleLootClass			= "Exile_Car_Ifrit";	// Vehicle Class that spawns if IMS_FortressVehicleLoot is true.
